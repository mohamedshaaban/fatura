...
var actions = {
   ...
   */
  registerCorporate: function registerCorporate(context, corporateData) {
    ...
    return axios__WEBPACK_IMPORTED_MODULE_0___default().post('/api/v1/register/corporate', submitData, {
      headers: {
