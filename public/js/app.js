...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_0__.mapActions)('authModule', ['registerUser'])), {}, {
    submit: function submit() {
      var _this = this;

      this.registerUser(_objectSpread({}, this.credentials)).then(function () {
        _this.$router.push({
          name: 'home'
        });
      })["catch"](function (errors) {
...
vue__WEBPACK_IMPORTED_MODULE_5__["default"].use(vue_router__WEBPACK_IMPORTED_MODULE_6__["default"]); // or however you determine your current app locale
...
axios.interceptors.request.use(function (requestConfig) {
  if (_store__WEBPACK_IMPORTED_MODULE_1__["default"].getters["authModule/isAuthenticated"]) {
    // console.log('sending authorization');
    // console.log(store.state.authModule.accessToken);
    requestConfig.headers.Authorization = "Bearer ".concat(_store__WEBPACK_IMPORTED_MODULE_1__["default"].state.authModule.accessToken);
  } else {
...
axios.interceptors.response.use(function (response) {
  ...
  if (error.response.status === 401) {
    ...
    _store__WEBPACK_IMPORTED_MODULE_1__["default"].commit('authModule/setAccessToken', null); // window.location.replace(`${window.location.origin}/login`);
  }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new vuex__WEBPACK_IMPORTED_MODULE_4__["default"].Store({
  modules: {
    authModule: _modules_auth__WEBPACK_IMPORTED_MODULE_2__
  },
  plugins: [(0,vuex_persistedstate__WEBPACK_IMPORTED_MODULE_0__["default"])({
    storage: {
      ...
      setItem: function setItem(key, value) {
        return js_cookie__WEBPACK_IMPORTED_MODULE_1__["default"].set(key, value, {
      ...
      removeItem: function removeItem(key) {
        return js_cookie__WEBPACK_IMPORTED_MODULE_1__["default"].remove(key);
      }
    }
  })]
}));
...
var getters = {
  isAuthenticated: function isAuthenticated(state) {
    ...
    return false; //return state.accessToken !== null;
  }
};
var actions = {
  /**
  ...
  registerUser: function registerUser(context, userData) {
    return axios__WEBPACK_IMPORTED_MODULE_0___default().post('/api/v1/register', userData).then(function (response) {
      ...
      var accessToken = response.data.access_token; // commit it
  ...
  */
  login: function login(context, credentials) {
    return axios__WEBPACK_IMPORTED_MODULE_0___default().post('/api/v1/login', credentials).then(function (response) {
      //check errors
      if (response.message) {
        return response;
      } else {
  ...
  return _c("div", [
    ...
    _c("div", { staticClass: "container innr-cont-area" }, [
      _c("div", { staticClass: "row" }, [
        _c("div", { staticClass: "col-sm-12 about-us" }, [
          _c(
            "form",
            {
            ...
            [
              _c("div", { staticClass: "form-group mt-10 mb-10 fullwidth" }, [
                _c("label", { attrs: { for: "exampleInputusername1" } }, [
                  _vm._v("usernameAddress")
                ]),
                _vm._v(" "),
                _c("input", {
                  directives: [
              ...
              _vm._v(" "),
              _c("div", { staticClass: "form-check clearfix mt-10 mb-10" }),
              _vm._v(" "),
              _c("br"),
              _vm._v(" "),
              _c("button", { staticClass: "btn btn-danger rounded-0" }, [
                _vm._v("login")
              ])
            ]
          )
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "innr-banner fullwidth" }, [
      _c("img", { attrs: { src: "images/wishlist-banner.jpg" } }),
      _vm._v(" "),
      _c("div", { staticClass: "heading" }, [_c("h2", [_vm._v("login")])])
    ])
  }
]
render._withStripped = true
            ...
            [
              ...
              _c("div", { staticClass: "form-group mt-10 mb-10 fullwidth" }, [
                ...
                _c("input", {
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.credentials.role,
                      expression: "credentials.role"
                    }
                  ],
                  staticClass: "form-control",
                  attrs: {
                  ...
                  domProps: { value: _vm.credentials.role },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                      }
                      _vm.$set(_vm.credentials, "role", $event.target.value)
                    }
                  }
                })
              ]),
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "innr-banner fullwidth" }, [
      _c("img", { attrs: { src: "images/wishlist-banner.jpg" } }),
      _vm._v(" "),
      _c("div", { staticClass: "heading" }, [_c("h2", [_vm._v("Register")])])
    ])
  }
]
render._withStripped = true
